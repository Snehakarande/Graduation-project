...
def login_page():
    ...
    login_window.title("Pathole Detection/Login")
...
menu_label = Label(MF, text="Path Hole Detection", font=("times new roman", 20, "bold"), bg="lightgray", fg="black", pady=0)
...
#Live button
b2 = Button(button_frame, font=("times new roman", 20, "bold"), text='Live', command=live_detection)
